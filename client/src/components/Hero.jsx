...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center
            ...
            bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-center
            bg-cover h-screen'>
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and confort await at the world's most exclusive Hotels
