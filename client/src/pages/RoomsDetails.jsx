...
const RoomsDetails = () => {
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            ...
            <p className='text-white bg-orange-500 rounded-full py-1.5 px-3 text-xs 
            font-inter '>20% OFF</p>
        </div>
        {/* display room rating */}
        <div className='flex items-center gap-1 mt-2'>
            {Array(5).fill(0).map((_, i)=>(
                <img key={i} src={room.rating > i?
                    assets.starIconFilled: assets.starIconOutlined
                    } alt="star-icon" />
            ))}
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
           <div className='flex flex-col'>
            <h1 className='text-3x1 md:text-4xl font-playfair'>Experience Luxury like never before</h1>
        ...
        shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
         ...
         <div className='background bg-gray-300/70 w-px h-15 max-md:hidden'></div>
          <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center
          gap-4 md:gap-10 text-gray-500'>
               <div className='flex flex-col'>
          ...
          gap-4 md:gap-10 text-gray-500'>
               ...
               <div className='flex flex-col'>
                ...
                border border-gray-300 px-3 py-2 mt-1.5 outline-none
                ' required/>
               </div>
          </div>
        ...
        <div>
            <p className='max-w-3x1 border-y border-gray-300 my-15 py-10 text-gray-500'>
                Guests will be allocated rooms on the ground floor accourding to the availability. The price quoted is 
                for two guests... 
            </p>
        </div>
        {/* Hosted by */}
